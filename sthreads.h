...
/* Use a semaphore for our mutex type */
...
/* Called at end of program, to cleanup.
*/
void deinit();
...
/* Join with a terminated thread
   ...
   terminated thread.
*/
tid_t join(const int);


/* Initialization and de-initialize a mutex lock
*/
int lock_init(mutex_t *);
int lock_deinit(mutex_t *);
